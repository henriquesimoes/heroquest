...
public class CharacterCard extends Card {
    ...
    public CharacterCard(Image characterImage, HeroesKind heroKind, String name, String description, Settings settings, Graphics2D graphics) {
        super(characterImage, name, description, graphics);
